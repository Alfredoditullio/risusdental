...
export const slides: SlideData[] = [
  ...
  },
  {
    ...
    bio: 'Desde los 12 años supo que quería ser odontólogo. Criado en Zárate, se formó en la UBA y convirtió esa vocación temprana en una carrera construida con estudio, pasión y mucha sensibilidad. Realizó posgrados en Ortodoncia y en Estética Facial, y trabaja con brackets convencionales, autoligado y ortodoncia invisible a través de Go Smile, su propia línea de alineadores — siempre al servicio de una sonrisa que sea tuya de verdad.\n\nEs además el creador de Candy Melo, su marca personal con la que lleva su mundo a otro nivel. Hoy es docente de Clínica en la UBA y en la Universidad Interamericana, porque cree que enseñar es también una forma de cuidar. En su tiempo libre lo encontrás sobre patines. Cree en las energías, en los vínculos y en que la salud empieza por sentirse escuchado. Su prioridad no es el diente: es la persona que lo tiene.',
    accentColor: '#1E8ED0',
    bgGradient:
